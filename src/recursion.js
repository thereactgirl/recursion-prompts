...
var factorial = function (n) {
  // base case is 1 smallest data is 1 or 0
  ...
  if (n === 1) {
    ...
    // if its bigger multiply n by factorial(n-1)
    n = n * factorial(n - 1);
...
var sum = function (array) {
  ...
  // if longer than 1 add its first number and take it from array
